...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">{content.problemSectionTitle}</h2>
                <div className="space-y-4 sm:space-y-6 text-gray-700 leading-relaxed">
                  {content.problemParagraphs?.map((paragraph, index) => (
                    <p key={index} className="text-base sm:text-lg">
                      {paragraph.includes('5000') ? (
                        paragraph.split('5000').map((part, i) => (
                          i === 0 ? part : <><strong>5000</strong>{part}</>
                        ))
                      ) : (
                        paragraph
                      )}
              ...
              <div className="bg-amber-50 border-l-4 border-amber-400 p-4 sm:p-6 rounded-r-xl">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-amber-800 mb-2 text-sm sm:text-base">{content.problemTipTitle}</h3>
                    <p className="text-amber-700 leading-relaxed text-sm sm:text-base">
                      {content.problemTipText}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-green-600 hover:bg-green-700 text-white px-6 sm:px-8 py-3 text-base"
                  asChild
                >
                  <a href={`tel:${settings.phoneNumber?.replace(/\s/g, '')}`}>
                    <Phone className="w-5 h-5 mr-2" />
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-gray-300 text-gray-700 px-6 sm:px-8 py-3 text-base bg-transparent"
                >
                  Meer Informatie
                </Button>
              </div>
            ...
            <div className="relative mt-8 lg:mt-0">
              <div className="relative z-10">
                {content.problemImage ? (
                  <Image
                    src={urlFor(content.problemImage).width(600).height(500).url()}
                    alt="Professional wasp control - WESPVRIJ expert in protective gear treating wasp nest"
                    width={600}
                    height={500}
                  ...
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Scherm%C2%ADafbeelding%202025-07-28%20om%2013.07.11-XUQEqcnr9zCrkNh3g5KRegY7a5tTYy.png"
                    alt="Professional wasp control - WESPVRIJ expert in protective gear treating wasp nest"
                    width={600}
                    height={500}
                    className="rounded-2xl shadow-xl object-cover w-full"
              ...
              <div className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 w-full h-full bg-amber-100 rounded-2xl -z-10"></div>

              {/* Stats overlay */}
              <div className="absolute bottom-4 left-4 sm:bottom-8 sm:left-8 bg-white/95 backdrop-blur-sm rounded-xl p-4 sm:p-6 shadow-lg">
                <div className="text-center">
                  <div className="text-2xl sm:text-3xl font-bold text-gray-900">{content.problemStatNumber}</div>
                  <div className="text-xs sm:text-sm text-gray-600">{content.problemStatText}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="text-center mt-12 sm:mt-16 space-y-4">
            <p className="text-gray-600 text-sm sm:text-base">
              Alle prijzen zijn inclusief BTW en reiskosten binnen Noord-Holland
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button
                variant="outline"
                size="lg"
                className="border-green-600 text-green-600 hover:bg-green-600 hover:text-white px-8 bg-transparent"
              >
              ...
              <div className="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <span>
                  Of bel direct: <strong>{settings.phoneNumber}</strong>
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 sm:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-4">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">{content.processSectionTitle}</h2>
                <p className="text-lg sm:text-xl text-gray-600">
                  {content.processSectionSubtitle}
                </p>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                {content.processSteps?.map((step, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1 text-base sm:text-lg">{step.title}</h3>
                      <p className="text-gray-600 text-sm sm:text-base">
                        {step.description}
                      </p>
                    </div>
            ...
            <div className="relative mt-8 lg:mt-0">
              {content.processImage ? (
                <Image
                  src={urlFor(content.processImage).width(600).height(500).url()}
                  alt="Professional wasp inspection process - WESPVRIJ expert with equipment"
                  width={600}
                  height={500}
                  className="rounded-2xl shadow-xl object-cover w-full"
                />
      ...
      {/* Reviews */}
      <section id="reviews" className="py-12 sm:py-20 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center space-y-4 mb-12 sm:mb-16">
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <span className="text-gray-500 text-sm sm:text-base">(127 reviews)</span>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 sm:py-16">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            ...
            <div className="space-y-4">
              <h4 className="text-base sm:text-lg font-semibold">Diensten</h4>
              <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
                {servicesData.map((service, index) => (
                  <li key={service._id || index}>{service.title}</li>
                ))}
